...
class UserTest extends TestCase
{
    ...
    public function test_cannot_disable_super_admin(): void
    {
        ...
        $response = $this->patchJson("/api/admin/users/{$superAdmin->id}/status", [
            'is_active' => false,
        ]);
    ...
    public function test_admin_can_reset_password(): void
    {
        ...
        $response = $this->postJson("/api/admin/users/{$target->id}/reset-password");
    ...
    public function test_cannot_reset_super_admin_password(): void
    {
        ...
        $response = $this->postJson("/api/admin/users/{$superAdmin->id}/reset-password");
    ...
    public function test_can_filter_users_by_keyword(): void
    {
        ...
        $response = $this->getJson('/api/admin/users?keyword=Alice');
    ...
    public function test_can_paginate_users(): void
    {
        ...
        $response = $this->getJson('/api/admin/users?page=2&page_size=5');
    ...
    public function test_update_user_validates_duplicate_email(): void
    {
        ...
        $response = $this->putJson("/api/admin/users/{$userA->id}", [
            'name' => $userA->name,
            'email' => $userB->email,
        ]);
    ...
    public function test_update_nonexistent_user_returns_error(): void
    {
        ...
        $response = $this->putJson('/api/admin/users/99999', [
            'name' => 'Ghost',
